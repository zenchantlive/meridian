"""
Parser for original MERIDIAN Brain format.
...
@dataclass
class SliderConfig:
    """Represents a MERIDIAN slider configuration."""
    name: str
    emoji: str
    default: int
    current: int
...
class PersonalityMode:
    """Represents a MERIDIAN personality mode."""
    name: str
    title: str
    description: str = ""
...
class MeridianConfig:
    """Main configuration class for MERIDIAN Brain."""
...
def activate_mode(config: MeridianConfig, mode: str) -> str:
