...
class TestMemorySafetyPolicy(unittest.TestCase):
    ...
    def test_project_boundary_blocks_cross_project_visibility(self):
        self.assertTrue(
            is_record_visible_to_project(record_project_id="meridian", active_project_id="meridian")
        )
        self.assertFalse(
            is_record_visible_to_project(record_project_id="other-project", active_project_id="meridian")
        )
