# MEMORY_PROTOCOL_LEGACY.md — Original MERIDIAN Memory Protocol

> Legacy document from the original MERIDIAN Brain format. The enhanced memory
...
- `project_meridian_architecture_complete.md`
...
1.  **Refactoring**: When a project evolves significantly (e.g., Python → Rust), **supersede** old memory files.
    -   Create new file: `project_meridian_architecture_rust.md`
