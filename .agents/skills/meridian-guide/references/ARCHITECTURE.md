# MERIDIAN Brain Architecture

## System Overview

MERIDIAN Brain Enhanced consists of two integrated subsystems:

1. **RLM Memory System** (New) - JSON-based persistent storage with graph linking
2. **MERIDIAN Framework** (Original) - Markdown-based configuration for personalities and behavior
...
### 2. Original MERIDIAN Framework Components
